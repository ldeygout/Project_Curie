...
data = pd.read_csv(r'C:\Users\LOCCO\Project_Curie\lambdadna\07_07_2026\lamelle_2\data_lam2_0707.csv',sep=',')
print(data.columns)
mask = tiff.imread(r"C:\Users\LOCCO\Project_Curie\lambdadna\07_07_2026\lamelle_2\Mask2_lam2_0707.tif")    
...
std.to_csv(r'C:\Users\LOCCO\Project_Curie\lambdadna\07_07_2026\lamelle_2\std_lam2_mask2_0707.csv', index=False)
...
th_lat= 5
th_axial = 11 #Obtenus après calcul de std
...
data_filtered.to_csv(r'C:\Users\LOCCO\Project_Curie\lambdadna\datatreated_lamelle2_0707.csv', index=False)
...
#Import data treated
data_treated = pd.read_csv(r'C:\Users\LOCCO\Project_Curie\lambdadna\datatreated_lamelle2_0707.csv',sep=',')
...
ax = rho_distribution(rho_treated)
plt.tight_layout()
plt.show()
