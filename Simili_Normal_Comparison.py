...
simili_X = np.array([rng.normal(np.mean(X_treated[:,0]), np.std(X_treated[:,0]), n_pts ), 
                    rng.normal(np.mean(X_treated[:,1]), np.std(X_treated[:,1]), n_pts ),
                    rng.normal(np.mean(X_treated[:,2]), np.std(X_treated[:,2]), n_pts )]).T
...
os.makedirs(r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_A2Z0CCD70150', exist_ok=True)
os.makedirs(r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_A2Z0CCD70150\minpts25', exist_ok=True)
...
joblib.dump(clust, r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_A2Z0CCD70150\minpts25\minpts25.pkl')
...
#With noise: consider stdx, stdy, stdz
