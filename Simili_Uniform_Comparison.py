...
simili_X = np.array([rng.uniform(min_x, max_x, n_pts ), 
                    rng.uniform(min_y, max_y, n_pts ),
                    rng.uniform(min_z, max_z, n_pts )]).T
...
os.makedirs(r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_uni_A2Z0CCD70150', exist_ok=True)
os.makedirs(r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_uni_A2Z0CCD70150\minpts25', exist_ok=True)
...
joblib.dump(clust, r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_uni_A2Z0CCD70150\minpts25\minpts25.pkl')


# In[ ]:


clust = joblib.load(r'C:\Users\LOCCO\Project_Curie\labmeeting\simili_uni_A2Z0CCD70150\minpts25\minpts25.pkl')
